...
- [rails/actionpack-action_caching](https://github.com/rails/actionpack-action_caching) 内では[利用できない](http://docs.ruby-lang.org/ja/search/query:Mutex%23synchronize/version:2.0.0/query:monitor/)
...
- [fluent/fluent-logger-ruby](https://github.com/fluent/fluent-logger-ruby) 
  ...
  - fluent_logger.rb で `Monitor#synchronize` が使われているので、Signal.trap
